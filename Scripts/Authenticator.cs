...
{
  public class Authenticator(AuthorizeContext Context)
  {
    private AuthorizeContext _context = Context;
    public string SignIn(AuthModel authData)
    {
      ...
      // var data =_context.Users.Where(b => b.Email == authData.Email).ToList();
      // if (data.Count == 0)
      //   return "NoToken";
      // var user = data[0];
